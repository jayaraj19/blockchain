...
# open_transactions list contains all transactions in it
...
def mine_block():
    ...
    # adding reward transaction to open_transactions
    # Copy transaction instead of manipulating the original open_transactionss list
...
while waiting_for_input:
    ...
    if user_choice == '1':
        ...
        # add transaction to the open_transactions
    ...
    # Mine block
        ...
        """ after mining that we is adding open_transactions to a block ,
        we create again a empty open_transactions for next block to come. """
        if mine_block():
            open_transactions = []
            save_data()
